                  ...
                  public void actionPerformed(ActionEvent ae) { 
                      ...
                      /*
                       ...
                       2. 반복문을 이용해서 curText를 한글자씩 읽어서
                          ...
                          2.1 만일 포함되어 있으면 sb에 저장하지 않고
                          2.2 포함되어 있지 않으면 sb에 저장한다.
                       3. 작업이 끝난 후에 sb에 담긴 내용을 ta에 보여준다.(setText()사용)

                     */
                        System.out.println(tfParam1.getText());
                        String[] arr = curText.split("");
                        for(int i = 0; i < arr.length; i++) {
                        	if(!tfParam1.getText().contains(arr[i])) sb.append(arr[i]);
                        }
